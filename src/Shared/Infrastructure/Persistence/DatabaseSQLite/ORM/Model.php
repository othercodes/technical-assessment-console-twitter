...
namespace Lookiero\Hiring\ConsoleTwitter\Shared\Infrastructure\Persistence\DatabaseSQLite\ORM;

use Lookiero\Hiring\ConsoleTwitter\Shared\Domain\Collection;
use Lookiero\Hiring\ConsoleTwitter\Shared\Domain\Container;
use Lookiero\Hiring\ConsoleTwitter\Shared\Infrastructure\DatabaseSQLite\Contracts\Connector;
...
abstract class Model extends Container
{
    ...
    public function __call(string $method, array $arguments)
    {
        ...
        if (in_array($method, ['select', 'where', 'groupBy', 'orderBy', 'limit'])) {
            call_user_func_array([self::$connector->query(), $method], $arguments);
            return $this;
        }
     ...
     * @return Connector
     */
    public static function setConnector(Connector $db): Connector
    {
        self::$connector = $db;
        return $db;
    }
